...
function GroupCardAdd() {
  ...
  return (
    <>
    <div className="w-[150px] h-[150px] bg-[#C3C4C5] rounded-[10px] flex justify-center items-center flex-col cursor-pointer -z-10" onClick={() => dispatch(openGroupListModal())}>
    ...
    {groupListModalState ? (<GroupListModal close={closeModal} isOpen={groupListModalState}/>) : null}
    </>
  )
}
