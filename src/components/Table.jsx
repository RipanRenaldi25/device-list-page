        ...
        <div className='p-4 text-center'>
            ...
            <div className="flex justify-center items-center mt-7">
                ...
                <div className="flex items-center">
                    {pageIndex === lastPage ? (<p>{ (pageIndex * pageSize + 1)}-{( pageIndex + 1 ) * (pageSize) - (pageSize * pageOptions.length - data.length)} page {pageIndex+1} of {pageOptions.length}</p>) : ( <p>{ (pageIndex * pageSize + 1)}-{( pageIndex + 1 ) * (pageSize)} page {pageIndex+1} of {pageOptions.length}</p>) }
